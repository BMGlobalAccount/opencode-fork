...
QR code is an `app.opencode.ai` link carrying the connection details: a phone camera
opens it in the OpenCode mobile app when installed, or in the web app otherwise.
